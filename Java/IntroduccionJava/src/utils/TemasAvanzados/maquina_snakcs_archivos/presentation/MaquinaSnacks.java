package utils.TemasAvanzados.maquina_snakcs_archivos.presentation;

import utils.TemasAvanzados.maquina_snakcs_archivos.dominio.Snack;
import utils.TemasAvanzados.maquina_snakcs_archivos.servicio.IServicioSnacks;
import utils.TemasAvanzados.maquina_snakcs_archivos.servicio.ServicioSnacksArchvios;
...
//        IServicioSnacks servicioSnacks = new ServicioSnacksLista();
        IServicioSnacks servicioSnacks = new ServicioSnacksArchvios();
        //Creamos la lista de productos de tipo snack
        List<Snack> productos = new ArrayList<>();
        System.out.println("*** Maquina de Snacks");
        servicioSnacks.mostrarSnacks(); // Mostrar inventario disponibles
        while (!salir){
            try {
    ...
    private static void comprarSnack(Scanner consola, List<Snack> productos, IServicioSnacks servicioSnacks){
        ...
        for (var snack: servicioSnacks.getSnacks()){
            if (idSnack == snack.getIdSnacks()){
                //Agregamos el snack a la lsita de productos
                productos.add(snack);
    ...
    private static void agregarSnack(Scanner consola, IServicioSnacks servicioSnacks){
        System.out.print("Nombrer del snack: ");

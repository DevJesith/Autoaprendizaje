...
public class ServicioSnacksArchvios implements IServicioSnacks {


    private final String NOMBRE_ARCHIVO = "snacks.txt";
    // Crear la lista de snacks
    private List<Snack> snakcs = new ArrayList<>();

    //Constructor clase
    public ServicioSnacksArchvios() {
    ...
    public void mostrarSnacks() {
        System.out.println("--- Snakcs en el inventario");
        var inventarioSnacks = "";
        for (var snack: this.snakcs){

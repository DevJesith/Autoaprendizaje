# Introducción
# En este ejercicio, practicará el flujo de control con bucles para resolver problemas. Se le dará una lista de enteros y tendrá que agregar algún código para encontrar un número concreto en una lista y devolverlo. 

JavaScript tiene objetos integrados muy útiles. Uno de estos objetos integrados populares es el objeto Math.

Al finalizar esta lectura, usted podrá:

Describir las propiedades y métodos integrados del objeto Math

Constantes numéricas
A continuación se muestran algunas de las constantes numéricas integradas que existen en el objeto Math:
...
A continuación se muestra una lista no concluyente de algunos métodos aritméticos y de cálculo comunes que existen en el  objeto Math  :

Math.pow(2,3)  - calcula el número  2  elevado a  3 , el resultado es  8 
